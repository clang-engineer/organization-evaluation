...
public interface RelationSurveyRepository
    ...
    Optional<List<RelationSurvey>> findByEvaulated(@Param("tno") long tno, @Param("sno") long sno);
    ...
    Optional<List<RelationSurvey>> findByEvaulator(@Param("tno") long tno, @Param("sno") long sno);
    ...
    Optional<List<RelationSurvey>> findAllByTno(@Param("tno") Long tno);
